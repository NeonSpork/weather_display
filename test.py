...
def parseJsonAndDrawToMask():
    ...
    rainMax1h = 239 - (2.5*12)
    rainMax2h = 239 - (2.5*12)
    rainMax3h = 239 - (2.5*12)
    rainMax4h = 239 - (2.5*12)
    rainMax5h = 239 - (2.5*12)
    rainMax6h = 239 - (2.5*12)
    rainMax7h = 239 - (4.5*12)
    rainMax8h = 239 - (4.5*12)
    rainMax9h = 239 - (4.5*12)
    rainMax10h = 239 - (3.5*12)
    rainMax11h = 239 - (3.5*12)
    rainMax12h = 239 - (3.5*12)
    if(rainMax1h > 0):
