...
def parseJsonAndDrawToMask():
    ...
    rainMax1h = 239 - (2.5*10)
    rainMax2h = 239 - (2.5*10)
    rainMax3h = 239 - (2.5*10)
    rainMax4h = 239 - (2.5*10)
    rainMax5h = 239 - (2.5*10)
    rainMax6h = 239 - (2.5*10)
    rainMax7h = 239 - (4.5*10)
    rainMax8h = 239 - (4.5*10)
    rainMax9h = 239 - (4.5*10)
    rainMax10h = 239 - (3.5*10)
    rainMax11h = 239 - (3.5*10)
    rainMax12h = 239 - (3.5*10)
    if(rainMax1h > 0):
