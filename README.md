...
This is a short step-by-step of how to set up a simple weather display with the 2.7 inch Waveshare display. The python code only runs in 2.7 because the Waveshare people wrote their library in 2.7.
